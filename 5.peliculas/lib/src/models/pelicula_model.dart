class Peliculas {
  ...
  Peliculas.fromJsonList( List<dynamic> jsonList ) {
    ...
    for (var item in jsonList ) {
      final pelicula = new Pelicula.fromJsonMap(item); // Le esta mandando
      // Las mapea todas las peliculas para meterlas dentro de esta lista
      items.add( pelicula );
...
class Pelicula {
  bool adult;
  String backdropPath;
  List<int> genreIds;  // Lisa de numeros no doubles
  int id;
  ...
  Pelicula.fromJsonMap(  Map<String, dynamic> json) {
          ...
          popularity    = json['popularity'] / 1; // Devolvera un double
          posterPath    = json['poster_path'];
          releaseDate   = json['release_date'];
          title         = json['title'];
          video         = json['video'];
          voteAverage   = json['vote_average'] / 1; // Para volverlo un double
          genreIds      = json['genre_ids'].cast<int>(); // Para tranformarlo en int
